...
public class purchaseReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnClear = findViewById(R.id.btnClearFilter); // layout id
        ...
        listPurchases.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent i = new Intent(purchaseReport.this, purchase.class);
    ...
    private void loadAllPurchases() {
        db.collection("Purchases")
                ...
                .addOnFailureListener(e -> Toast.makeText(this, "Failed to load purchases: " + e.getMessage(), Toast.LENGTH_LONG).show());
    }
    ...
    private void sendPdfToWhatsapp(String phone) {
        try {
            ...
            File pdfFile = new File(invoiceDir, "purchase_report_temp.pdf");
    ...
    private void createPdfFile(File f) throws Exception {
        ...
        p.setTextSize(18);
        c.drawText("Purchase Report", 20, y, p);
        y += 25;
    ...
    private void exportCsv() {
        try {
            File f = new File(getExternalFilesDir(null), "purchase_report.csv");
            FileOutputStream fos = new FileOutputStream(f);
    ...
    private void sendExcelToWhatsapp(String phone) {
        try {
            ...
            File excelFile = new File(invoiceDir, "purchase_report_temp.csv");
    ...
    private void printReport() {
        try {
            ...
            pm.print("PurchaseReport", adapter, pa);
